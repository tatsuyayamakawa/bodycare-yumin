...
import mediaImage01 from 'public/media-01.jpg';
import mediaImage02 from 'public/media-02.png';
  ...
  return (
    <section>
      <div className="my-[6.25rem] max-w-[62rem] md:mx-5 lg:mx-auto">
        <Typography
          variant="h2"
          className="mx-5 mb-10 text-center font-notojp text-3xl font-medium leading-relaxed tracking-wide text-accent lg:text-4xl"
        >

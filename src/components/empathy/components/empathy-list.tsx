...
export default function EmpathyList({ lists }: EmpathyListProps) {
  return (
    <div className="flex flex-col">
      <h2 className="text-brand-primary mb-12 text-center text-lg/normal md:my-8 md:text-xl/normal lg:text-2xl/normal xl:mt-16 xl:mb-10 xl:text-3xl/normal">
      ...
      <ul className="space-y-4 text-sm/normal md:text-base/normal lg:text-base/normal xl:text-lg/normal">

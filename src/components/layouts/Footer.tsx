...
const Footer = () => {
  return (
    <footer className="bg-secondary py-10 text-lg font-normal laptop:px-10">
      <div className="mb-20 mt-10 flex items-center justify-center mobile:mx-10 mobile:flex-col mobile:gap-10 laptop:flex-row laptop:gap-20">
        <motion.div
          initial="hidden"
          whileInView="visible"
          variants={scale}
          viewport={{ once: true }}
          className="mobile:w-full laptop:w-1/2 desktop:w-2/6"
        >
          <a href="https://lin.ee/wzPQgmv" target="_blank">
            <Button
              color="white"
              className="w-full bg-white py-5 font-notojp font-bold text-primary mobile:px-10 mobile:text-xl laptop:text-2xl"
            >
              ...
              <div className="mt-2 font-normal text-gray-50 mobile:text-xs laptop:text-sm">
        ...
        >
          <a href="https://forms.gle/a8qo8Cr1snXYHTMp8" target="_blank">
            <Button
              color="white"
              className="w-full bg-white py-5 font-notojp text-2xl font-bold text-primary mobile:text-xl laptop:text-2xl"
            >
              <div className="flex items-center justify-center gap-3 ">
      ...
      <div className="mx-10 flex items-center justify-between mobile:flex-col mobile:gap-10 laptop:flex-row">

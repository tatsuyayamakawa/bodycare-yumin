...
export const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      "当院では、マッサージではなかなか届かないコリの根本原因となる深層筋をほぐしていきます。",
    ],
    imagePosition: "right",
    reverse: true,
  },
  {
    ...
    content: [
      "深層筋をほぐすと、体内の体液、リンパ液、血液の循環が改善し、自然治癒力が活性化して体の疲れが内側から回復します。",
      "当院では、この自然治癒力を最大限に引き出し、お客様自身で健康な体を取り戻せるように促すのが整体療術方針です。",
      "当院のお客様の多くが、施術後すぐに体の何らかの変化を感じています。それは体の軽さや体温の変化などさまざまですが、深層筋整体の効果を証明しています。",

...
export default function ReviewCard({ review }: ReviewCardProps) {
  return (
    <div className="md:w-[calc(100%/2-16px)] xl:w-[calc(100%/2-24px)]">
      <div className="bg-card text-brand-primary mb-4 rounded-lg px-4 py-2 lg:mb-6 lg:px-6 lg:py-4 [&>*]:my-2">
